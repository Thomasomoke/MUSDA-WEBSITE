...
const MapSection = () => {
    const embeddedMapURL = "https://maps.app.goo.gl/7HVMh53m9UncEb2m7"; // Replace this!
    const churchAddress = "[Your Church Street Address], [Your City/Town], Kenya"; // Add your address
