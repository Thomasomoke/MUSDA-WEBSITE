...
const Visit = ({ isPopup, setIsPopup }) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-xl font-bold mb-22">Plan Your Visit</h2>
                <p className="mb-2">Please fill out the form below if you'd like to let us know you're planning a visit.</p>
