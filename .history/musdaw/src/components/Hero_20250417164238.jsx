        ...
        <div className="relative h-screen flex items-center justify-center bg-gray-900">
            ...
            >
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
                    Welcome to <span className="text-blue-300">Saint Mary's</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button className="bg-transparent border-2 border-white/20 hover:border-white/40 text-white px-8 py-3 rounded-lg transition-colors">
                        Visit Us
                    </button>
                </div>
            </motion.div>
