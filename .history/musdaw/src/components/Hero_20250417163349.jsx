        ...
        <div className="relative h-screen flex items-center justify-center bg-cover bg-center overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4">
                ...
                >
                    ...
                    <motion.p
                        variants={slideUp}
                        className="text-lg md:text-xl lg:text-2xl text-gray-200 font-light max-w-3xl mx-auto mb-8"
                    >
                        Experience luxury travel redefined. Explore curated destinations with exclusive benefits and personalized service.
                    </motion.p>
